...
/* Instruction building/extraction support for leg. -*- C -*-
...
const char * leg_cgen_insert_operand
...
const char *
leg_cgen_insert_operand (CGEN_CPU_DESC cd,
			     int opindex,
			     CGEN_FIELDS * fields,
			     CGEN_INSN_BYTES_PTR buffer,
			     bfd_vma pc ATTRIBUTE_UNUSED)
...
cgen_insert_fn * const leg_cgen_insert_handlers[] =
{
  insert_insn_normal,
};

cgen_extract_fn * const leg_cgen_extract_handlers[] =
{
  extract_insn_normal,
};

int leg_cgen_get_int_operand     (CGEN_CPU_DESC, int, const CGEN_FIELDS *);
bfd_vma leg_cgen_get_vma_operand (CGEN_CPU_DESC, int, const CGEN_FIELDS *);
...
int
leg_cgen_get_int_operand (CGEN_CPU_DESC cd ATTRIBUTE_UNUSED,
			     int opindex,
...
bfd_vma
leg_cgen_get_vma_operand (CGEN_CPU_DESC cd ATTRIBUTE_UNUSED,
			     int opindex,
			     const CGEN_FIELDS * fields)
{
  bfd_vma value;
...
void leg_cgen_set_int_operand  (CGEN_CPU_DESC, int, CGEN_FIELDS *, int);
void leg_cgen_set_vma_operand  (CGEN_CPU_DESC, int, CGEN_FIELDS *, bfd_vma);
...
void
leg_cgen_set_int_operand (CGEN_CPU_DESC cd ATTRIBUTE_UNUSED,
			     int opindex,
			     CGEN_FIELDS * fields,
			     int value)
{
...
void
leg_cgen_set_vma_operand (CGEN_CPU_DESC cd ATTRIBUTE_UNUSED,
			     int opindex,
			     CGEN_FIELDS * fields,
			     bfd_vma value)
{
...
void
leg_cgen_init_ibld_table (CGEN_CPU_DESC cd)
{
  cd->insert_handlers = & leg_cgen_insert_handlers[0];
  cd->extract_handlers = & leg_cgen_extract_handlers[0];

  cd->insert_operand = leg_cgen_insert_operand;
  cd->extract_operand = leg_cgen_extract_operand;

  cd->get_int_operand = leg_cgen_get_int_operand;
  cd->set_int_operand = leg_cgen_set_int_operand;
  cd->get_vma_operand = leg_cgen_get_vma_operand;
  cd->set_vma_operand = leg_cgen_set_vma_operand;
}
