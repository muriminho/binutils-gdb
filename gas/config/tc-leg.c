...
#include "bfd.h"
#include "safe-ctype.h"
#include "opcodes/leg-desc.h"
#include "opcodes/leg-opc.h"
#include "cgen.h"
#include "elf/leg.h"
...
md_begin (void)
{
  ...
  gas_cgen_cpu_desc = leg_cgen_cpu_open (CGEN_CPU_OPEN_MACHS, 0,
					   CGEN_CPU_OPEN_ENDIAN,
					   CGEN_ENDIAN_BIG,
					   CGEN_CPU_OPEN_END);
  leg_cgen_init_asm (gas_cgen_cpu_desc);

  /* This is a callback from cgen to gas to parse operands.  */
  cgen_set_parse_operand_fn (gas_cgen_cpu_desc, gas_cgen_parse_operand);

  if (! bfd_set_arch_mach (stdoutput, bfd_arch_leg, bfd_mach_leg))
...
md_assemble (char * str)
{
  ...
  insn.insn = leg_cgen_assemble_insn
